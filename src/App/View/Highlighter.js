...
exports.highlightClass = createReactClass({
  render: function () {
    ...
    return React.createElement(highlighter.default, {
      ...
      codeTagProps: {style: {paddingTop: "10px", display: 'block', float: 'left', width: '1200px', flexGrow: 100, minHeight: '100%' }},
      lineNumberContainerStyle: { textAlign: 'right',  padding: '10px', float: 'left', backgroundColor: '#fafafa', boxSizing: 'border-box', minHeight: '100%' },
      lineNumberStyle: { color: 'rgba(0,0,0,0.3)', fontSize: '12px', lineHeight: '19px', width: '38px', display: 'block' },
      customStyle: { marginBottom: 0, marginLeft: 0, marginTop: 0, padding: 0, boxSizing: 'border-box', height: '100%', position: 'relative', overflowY: 'scroll' },
