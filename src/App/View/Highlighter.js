...
exports.highlightClass = createReactClass({
  render: function () {
    ...
    return React.createElement(highlighter.default, {
      ...
      codeTagProps: {style: {paddingTop: "10px", display: 'block', float: 'left', width: '1200px', flexGrow: 100 }},
      ...
      customStyle: { marginBottom: 0, marginLeft: 0, marginTop: 0, padding: 0, boxSizing: 'border-box', height: '100%', display: 'flex' },
